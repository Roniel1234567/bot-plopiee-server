...
- Responde en 2-4 oraciones, con naturalidad. Evita sonar telegráfico o cortante; un poco de calidez y contexto está bien, pero sin irte por las ramas.
    ...
    if (esErrorDeCuota) {
      ...
      try {
        const retryResponse = await ai.models.generateContent({
          model: 'gemini-3.1-flash-lite',
          contents: mensajeUsuario,
          config: { systemInstruction, maxOutputTokens: 170 },
        });
